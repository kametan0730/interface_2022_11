...
# router1のリンクの設定
setup_link router1 router1-host1
setup_link router1 router1-router2
setup_link router1 router1-router4
...
ip netns exec router3 ip route add 192.168.0.0/24 via 192.168.3.2
